...
exports.VinSolutionsExtractor = void 0;
const playwright_1 = require("playwright");
const path_1 = __importDefault(require("path"));
const fs_extra_1 = __importDefault(require("fs-extra"));
class VinSolutionsExtractor {
    browser = null;
    page = null;
    screenshots = [];
    async initialize() {
        ...
        this.page.on('download', async (download) => {
            ...
            const downloadPath = path_1.default.join('./downloads', `${timestamp}_${filename}`);
    ...
    async takeScreenshot(name) {
        ...
        await fs_extra_1.default.ensureDir('./screenshots');
    ...
    async extractReport(credentials) {
        try {
...
exports.VinSolutionsExtractor = VinSolutionsExtractor;
//# sourceMappingURL=VinSolutionsExtractor.js.map