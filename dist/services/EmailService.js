...
class EmailService {
    ...
    async sendReportEmail(reportPath, reportName, platformName, extractionMetadata) {
        try {
...
This is an automated message from your VinSolutions AI Agent.
    ...
    async waitForTwoFactorCode(timeoutMs = 300000, // 5 minutes default
    fromDomain = 'vinsolutions.com') {
    ...
    async sendNotificationEmail(subject, message, isError = false) {
        try {
            const emoji = isError ? '❌' : '✅';
