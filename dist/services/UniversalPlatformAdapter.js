...
const PerceptionService_1 = require("./PerceptionService");
...
class UniversalPlatformAdapter {
    ...
    constructor(platformName, config, platformConfig) {
        ...
        this.perceptionService = new PerceptionService_1.PerceptionService();
        this.visionService = new VisionService_1.VisionService();
    }
    ...
    async attemptIntelligentLogin(credentials, perception) {
        try {
            // Use vision to find username field
            const usernameField = await this.visionService.findElementByDescription(this.page, 'username input field');
            ...
            const passwordField = await this.visionService.findElementByDescription(this.page, 'password input field');
            ...
            const loginButton = await this.visionService.findElementByDescription(this.page, 'login button');
    ...
    async attemptIntelligentNavigation() {
        try {
            const reportsNav = await this.visionService.findElementByDescription(this.page, 'Reports navigation link');
    ...
    async findReport(reportName) {
        ...
        const reportElement = await this.visionService.findElementByDescription(this.page, `${reportName} report`);
    ...
    async downloadReport() {
        ...
        const downloadButton = await this.visionService.findElementByDescription(this.page, 'Download button');
